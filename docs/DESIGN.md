...
> Design notes for **python-game-media-multipart** — a runnable python example that Python multipart uploader for large game recordings and creator media files.
...
- **Feature code** — the actual task: game-media-upload.
